...
<body>
	<form action="/database/workOrder/insert">
		<table border="1" cellpadding="5">
			...
			<tr>
				<th>Quote Created Time:</th>
				<td>${createdTime}<input type="hidden" name="quoteCreatedTime"
					size="45" value="${createdTime}" onfocus="this.value=''" /></td>
			</tr>
			<tr>
				<th>Tree ID:</th>
				<td>${treeID}<input type="hidden" name="treeID" size="45"
			...
			<tr>
				...
				<td><input type="datetime-local" name="dueDate" size="45"
					value="" onfocus="this.value=''" /></td>
			</tr>
			<tr>
				<th>Description:</th>
				<td><input type="text" name="description" size="45"
					value="Example Description" onfocus="this.value=''" /></td>
			</tr>
			<tr>
